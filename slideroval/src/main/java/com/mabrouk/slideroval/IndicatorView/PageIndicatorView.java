...
import com.mabrouk.slideroval.IndicatorView.animation.type.ScaleAnimation;
import com.mabrouk.slideroval.IndicatorView.draw.controller.DrawController;
import com.mabrouk.slideroval.IndicatorView.draw.data.Indicator;
import com.mabrouk.slideroval.IndicatorView.draw.data.Orientation;
import com.mabrouk.slideroval.IndicatorView.draw.data.PositionSavedState;
import com.mabrouk.slideroval.IndicatorView.draw.data.RtlMode;
import com.mabrouk.slideroval.IndicatorView.utils.CoordinatesUtils;
import com.mabrouk.slideroval.IndicatorView.utils.DensityUtils;
import com.mabrouk.slideroval.IndicatorView.utils.IdUtils;
import com.mabrouk.slideroval.R;
...
public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener, IndicatorManager.Listener, ViewPager.OnAdapterChangeListener {
    ...
    public void setIndectorReduis(int reduis){
         manager.drawer().attributeController.setRadius(reduis==0?0:reduis+2);
         invalidate();
    }
    ...
    private void init(@Nullable AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PageIndicatorView, 0, 0);
        setupId();
