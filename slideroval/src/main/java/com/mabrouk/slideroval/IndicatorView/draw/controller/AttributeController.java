package com.mabrouk.slideroval.IndicatorView.draw.controller;
...
import com.mabrouk.slideroval.IndicatorView.animation.type.BaseAnimation;
import com.mabrouk.slideroval.IndicatorView.animation.type.ColorAnimation;
import com.mabrouk.slideroval.IndicatorView.animation.type.FillAnimation;
...
public class AttributeController {
    ...
    private void initSizeAttribute(@NonNull TypedArray typedArray) {
        ...
        if (orientationIndex == 0) {
         ...
         radius = (int) typedArray.getDimension(R.styleable.PageIndicatorView_piv_radius, DensityUtils.dpToPx(Indicator.DEFAULT_RADIUS_DP));
        if (radius < 0) {
            radius = 0;
        }
